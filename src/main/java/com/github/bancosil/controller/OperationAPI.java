...
@Tag(name = "Operações", description = "Operações que um usuário pode fazer.")
public interface OperationAPI {
    ...
    ResponseEntity<String> deposit(@RequestBody @Valid DepositCommand depositCommand);
    ...
    @ApiResponse(responseCode = HttpConstants.SERVER_ERROR, description = HttpConstants.INTERN_SERVER_ERROR_MSG)
    ResponseEntity<String> withdraw(@RequestBody @Valid WithdrawCommand withdrawCommand);
    ...
    @ApiResponse(responseCode = HttpConstants.SERVER_ERROR, description = HttpConstants.INTERN_SERVER_ERROR_MSG)
    ResponseEntity<String> transfer(@RequestBody @Valid TransferCommand transferCommand);
}
